...
本文介绍如何基于[盘古开发框架](https://pulanos.gitee.io/pangu-framework) 开发一个单体分层架构的应用。文中所述仅为搭建一个单体应用的基本框架，增加**配置中心、数据持久化、缓存等能力**请参考 **[开发指南](https://pulanos.gitee.io/pangu-framework/docs/intro)** 的相关章节。
